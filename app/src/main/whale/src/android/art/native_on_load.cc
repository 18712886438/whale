...
static jlong
WhaleRuntime_getMethodSlot(JNI_START, jobject method_obj) {
    auto runtime = whale::art::ArtRuntime::Get();
    return runtime->GetMethodSlot(env, cl, method_obj);
}
...
static void
WhaleRuntime_addHookedMethod(JNI_START, jobject method_obj) {
    auto runtime = whale::art::ArtRuntime::Get();
    return runtime->addHookedMethod(env, cl, method_obj);
}
...
static JNINativeMethod gMethods[] = {
        ...
        NATIVE_METHOD(WhaleRuntime, removeFinalFlagNative,
                      "(Ljava/lang/Class;)V"),
        NATIVE_METHOD(WhaleRuntime, addHookedMethod, "(Ljava/lang/reflect/Member;)V"),
